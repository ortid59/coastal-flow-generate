...
export const DEFAULT_PROPOSAL_SETTINGS: ProposalSettings = {
  ...
  next_steps_body: [
    "Client reviews the media plan and provides feedback.",
    "Coastal Maverick incorporates adjustments as needed.",
    "Client approves the final plan within one week.",
    "Coastal Maverick issues an insertion order/signature authorization for client approval before securing vendor contracts.",
    "Coastal Maverick shares production specs/grids (creative due 3 weeks prior to contract start).",
    "Client develops creative; Coastal Maverick can assist with this as needed (additional fee).",
    "Coastal Maverick manages production and provides proofs for approval.",
    "Coastal Maverick oversees production, confirms material delivery, and issues posting instructions to vendors.",
    "Posting is confirmed at campaign launch.",
    "Coastal Maverick monitors campaign delivery, providing a formal Proof of Performance deck.",
    "Coastal Maverick conducts performance analysis and shares insights to inform future planning.",
  ].join("\n"),
  footer_tagline: "",
