...
export const DEFAULT_PROPOSAL_SETTINGS: ProposalSettings = {
  ...
  next_steps_body: [
    "Client reviews media plan",
    "CM incorporates feedback",
    "Client approves final plan",
    "Insertion order signed",
    "Production specs shared",
    "Creative developed",
    "Proofs approved",
    "Materials shipped to vendors",
    "Campaign launch confirmed",
    "Delivery monitored & POP deck",
